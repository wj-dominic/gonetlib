...
func (x *REQ_ECHO) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*REQ_ECHO) ProtoMessage() {}

func (x *REQ_ECHO) ProtoReflect() protoreflect.Message {
	mi := &file_idl_proto_msgTypes[0]
...
// Deprecated: Use REQ_ECHO.ProtoReflect.Descriptor instead.
func (*REQ_ECHO) Descriptor() ([]byte, []int) {
	return file_idl_proto_rawDescGZIP(), []int{0}
}

func (x *REQ_ECHO) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *RES_ECHO) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RES_ECHO) ProtoMessage() {}

func (x *RES_ECHO) ProtoReflect() protoreflect.Message {
	mi := &file_idl_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RES_ECHO.ProtoReflect.Descriptor instead.
func (*RES_ECHO) Descriptor() ([]byte, []int) {
	return file_idl_proto_rawDescGZIP(), []int{1}
}

func (x *RES_ECHO) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_idl_proto_rawDesc = []byte{
	0x0a, 0x09, 0x69, 0x64, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x24, 0x0a, 0x08, 0x52,
	0x45, 0x51, 0x5f, 0x45, 0x43, 0x48, 0x4f, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x22, 0x24, 0x0a, 0x08, 0x52, 0x45, 0x53, 0x5f, 0x45, 0x43, 0x48, 0x4f, 0x12, 0x18, 0x0a,
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2e, 0x2f, 0x69, 0x64,
...
var file_idl_proto_goTypes = []interface{}{
	(*REQ_ECHO)(nil), // 0: REQ_ECHO
	(*RES_ECHO)(nil), // 1: RES_ECHO
}
